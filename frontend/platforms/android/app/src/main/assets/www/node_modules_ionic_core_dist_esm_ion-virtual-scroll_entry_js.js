...
const VirtualScroll = class {
  ...
  updateVirtualScroll() {
    ...
    (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.readVS.bind(this));
    (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.c)(this.writeVS.bind(this));
  }
  readVS() {
  ...
  updateCellHeight(cell, node) {
    ...
    if (node) {
      (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_1__.c)(node, update);
    }
    else {
      update();
    }
  ...
  render() {
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { style: {
        height: `${this.totalHeight}px`,
      } }, this.renderItem && ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map((node) => this.renderVirtualNode(node))))));
  }
