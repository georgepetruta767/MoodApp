...
const Textarea = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el, ['title']);
  }
  componentDidLoad() {
    (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => this.runAutoGrow());
  }
  runAutoGrow() {
    const nativeInput = this.nativeInput;
  ...
  render() {
    ...
    const label = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_2__.j)(this.el);
    if (label) {
      label.id = labelId;
    }
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { "aria-disabled": this.disabled ? 'true' : null, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
        [mode]: true,
      }) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "textarea-wrapper", ref: (el) => (this.textareaWrapper = el) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", Object.assign({ class: "native-textarea", "aria-labelledby": label ? labelId : null, ref: (el) => (this.nativeInput = el), autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, disabled: this.disabled, maxLength: this.maxlength, minLength: this.minlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown }, this.inheritedAttributes), value))));
  }
