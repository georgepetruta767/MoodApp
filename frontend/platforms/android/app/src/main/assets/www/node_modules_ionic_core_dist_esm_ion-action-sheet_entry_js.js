...
/* harmony import */ var _button_active_70de495b_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-70de495b.js */ 98323);
/* harmony import */ var _overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-1159a357.js */ 67434);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./theme-7670341c.js */ 82187);
/* harmony import */ var _animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./animation-968c84bb.js */ 52059);
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 71830);
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 92503);
/* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./gesture-controller-17e82006.js */ 79398);
/* harmony import */ var _hardware_back_button_490df115_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./hardware-back-button-490df115.js */ 8657);
/* harmony import */ var _helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helpers-1ec1a6dd.js */ 69098);
/*!
...
const iosEnterAnimation = (baseEl) => {
  const baseAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  backdropAnimation
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetDidPresent", 7);
    this.willPresent = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetWillPresent", 7);
    this.willDismiss = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetWillDismiss", 7);
    this.didDismiss = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionActionSheetDidDismiss", 7);
   ...
   */
  present() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
  }
  connectedCallback() {
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the action sheet did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionActionSheetWillDismiss');
  }
  ...
  async callButtonHandler(button) {
    if (button) {
      ...
      const rtn = await (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler);
      if (rtn === false) {
  ...
  componentDidLoad() {
    ...
    if (this.gesture || (0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'md' || !wrapperEl || !groupEl) {
      return;
    }
    (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.f)(() => {
      const isScrollable = groupEl.scrollHeight > groupEl.clientHeight;
      if (!isScrollable) {
        this.gesture = (0,_button_active_70de495b_js__WEBPACK_IMPORTED_MODULE_2__.c)(wrapperEl, (refEl) => refEl.classList.contains('action-sheet-button'));
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ role: "dialog", "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, class: Object.assign(Object.assign({ [mode]: true }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.cssClass)), { 'overlay-hidden': true, 'action-sheet-translucent': this.translucent }), onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { tappable: this.backdropDismiss }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-wrapper ion-overlay-wrapper", role: "dialog", ref: (el) => (this.wrapperEl = el) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-container" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-group", ref: (el) => (this.groupEl = el) }, this.header !== undefined && ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        'action-sheet-title': true,
        'action-sheet-has-sub-title': this.subHeader !== undefined,
      } }, this.header, this.subHeader && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-sub-title" }, this.subHeader))), buttons.map((b) => ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", id: b.id, class: buttonClass(b), onClick: () => this.buttonClick(b) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "action-sheet-button-inner" }, b.icon && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: b.icon, lazy: false, class: "action-sheet-icon" }), b.text), mode === 'md' && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null))))), cancelButton && ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "action-sheet-group action-sheet-group-cancel" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: buttonClass(cancelButton), onClick: () => this.buttonClick(cancelButton) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "action-sheet-button-inner" }, cancelButton.icon && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: cancelButton.icon, lazy: false, class: "action-sheet-icon" }), cancelButton.text), mode === 'md' && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null)))))), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" })));
  }
  get el() { return (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
const buttonClass = (button) => {
  return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, 'ion-focusable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.g)(button.cssClass));
};
ActionSheet.style = {
