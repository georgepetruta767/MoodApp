...
/* harmony import */ var _overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-1159a357.js */ 67434);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./theme-7670341c.js */ 82187);
/* harmony import */ var _index_c71f6940_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-c71f6940.js */ 5516);
/* harmony import */ var _animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animation-968c84bb.js */ 52059);
/* harmony import */ var _hardware_back_button_490df115_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hardware-back-button-490df115.js */ 8657);
/*!
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.g)(parentPopoverEl);
...
const focusItem = (item) => {
  const root = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  backdropAnimation
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const contentAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const viewportAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  backdropAnimation
    .addElement(root.querySelector('ion-backdrop'))
    .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
    .beforeStyles({
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPopoverDidDismiss", 7);
  ...
  componentWillLoad() {
    ...
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    ...
    if (parentPopover) {
      (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  async present(event) {
    ...
    this.usersElement = await (0,_framework_delegate_0d4f56b1_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, this.el, this.component, ['popover-viewport'], data, inline);
    await (0,_index_c71f6940_js__WEBPACK_IMPORTED_MODULE_6__.e)(this.usersElement);
    if (!this.keyboardEvents) {
      this.configureKeyboardInteraction();
    }
    this.configureDismissInteraction();
    this.currentTransition = (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
    ...
    if (this.focusDescendantOnPresent) {
      (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__.j)(this.el, this.el);
    }
  }
  /**
  ...
  async dismiss(data, role, dismissParentPopover = true) {
    ...
    this.currentTransition = (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_1__.a)('desktop');
    const enableArrow = arrow && !parentPopover;
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "aria-modal": "true", "no-router": true, tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, id: popoverId, class: Object.assign(Object.assign({}, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.cssClass)), { [mode]: true, 'popover-translucent': this.translucent, 'overlay-hidden': true, 'popover-desktop': desktop, [`popover-side-${side}`]: true, 'popover-nested': !!parentPopover }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonBackdropTap: this.onBackdropTap }), !parentPopover && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop, part: "backdrop" }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-wrapper ion-overlay-wrapper", onClick: dismissOnSelect ? () => this.dismiss() : undefined }, enableArrow && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-arrow", part: "arrow" }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "popover-content", part: "content" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)))));
  }
