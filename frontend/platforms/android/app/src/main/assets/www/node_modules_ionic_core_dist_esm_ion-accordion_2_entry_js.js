(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([["node_modules_ionic_core_dist_esm_ion-accordion_2_entry_js"],{
...
const Accordion = class {
  constructor(hostRef) {
     ...
     * or collapsed.
     */
    this.toggleIcon = _index_e3f61316_js__WEBPACK_IMPORTED_MODULE_1__.i;
    /**
    ...
    this.setAria = (expanded = false) => {
       ...
       */
      const root = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
          ...
          this.currentRaf = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
            const waitForTransition = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.t)(contentEl, 2000);
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.c.get('animated', true);
      if (!animated) {
        return false;
      }
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.a)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.b)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: {
        ...
        'accordion-animated': _ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('animated', true),
      } }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { onClick: () => this.toggleExpanded(), id: "header", part: headerPart, "aria-controls": "content", ref: (headerEl) => (this.headerEl = headerEl) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "header" })), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "content", part: contentPart, role: "region", "aria-labelledby": "header", ref: (contentEl) => (this.contentEl = contentEl) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "content-wrapper", ref: (contentElWrapper) => (this.contentElWrapper = contentElWrapper) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "content" })))));
  }
...
const AccordionGroup = class {
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: {
      ...
      }, role: "presentation" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
  get el() { return (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
