...
const Toggle = class {
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      (0,_haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_3__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__.c)(color, {
        [mode]: true,
        ...
        interactive: true,
      }) }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon", part: "track" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon-wrapper" }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-inner", part: "handle" }))), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: inputId }, labelText), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", role: "switch", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
