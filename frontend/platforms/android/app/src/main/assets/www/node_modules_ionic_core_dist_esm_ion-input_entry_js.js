...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el, ['aria-label', 'tabindex', 'title']);
  }
  connectedCallback() {
    this.emitStyle();
